...
public class NoiseEffect : MonoBehaviour
{
    ...
    public float grainIntensityMin = 0;//0.1f;
    public float grainIntensityMax = 0;//0.2f;

    /// The size of the noise grains (1 = one pixel).
    public float grainSize = 2.0f;

    // Scratches take random intensity from Min to Max.
    public float scratchIntensityMin = 0;//0.05f;
    public float scratchIntensityMax = 0;//0.25f;
    ...
    protected void Start()
    {
        ...
        shaderRGB = (Shader)Resources.Load("NoiseEffectShaderRGB");
        shaderYUV = (Shader)Resources.Load("NoiseEffectShaderYUV");
